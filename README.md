...
### I don't know if there is any other good way, but this can avoid the problems caused by different bbolt namespaces (some are go.etcd.io/bbolt, some are github.com/coreos/bbolt)
